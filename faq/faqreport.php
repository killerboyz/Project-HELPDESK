				...
				<div class="row">
					<div class="col-md-6">
						<div class="panel panel-info">
							...
							<div class="panel-body">
								...
								<form class="form-horizontal" action="/faq/printreport.php?by=month" method="post" target="_blank">
					...
					<div class="col-md-6 ">
						<div class="panel panel-info">
							...
							<div class="panel-body">
								<form class="form-horizontal" action="/faq/printreport.php?by=options" method="post" target="_blank">
									<div class="row">
										<fieldset>
									...
									<div class="row">
										...
										<div class="col-md-8">
											<div class="input-daterange input-group" id="datepicker">
												<input type="text" class="input-sm form-control" onkeydown="return false" name="start" autocomplete="off"/>
												<span class="input-group-addon">to</span>
												<input type="text" class="input-sm form-control" onkeydown="return false" name="end" autocomplete="off"/>
											</div>
										</div>
									</div>
								...
								หากไม่ได้เลือกวันที่ Create On ไว้ วันที่ในหัวกระดาษจะนับจากวันที่ Create On ของ FAQ ID แรก และ สุดท้าย ในตาราง</p>
